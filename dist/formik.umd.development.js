        ...
        function Formik(props) {
            ...
            _this.handleChange = function (eventOrPath) {
                var executeChange = function (eventOrTextValue, maybePath) {
                    ...
                    if (field) {
                        _this.setState(function (prevState) { return (__assign({}, prevState, { values: setIn(prevState.values, field, val), lastTouched: field })); }, function () {
                            if (_this.props.validateOnChange) {
            ...
            _this.setFieldTouched = function (field, touched, shouldValidate) {
                ...
                if (shouldValidate === void 0) { shouldValidate = true; }
                _this.setState(function (prevState) { return (__assign({}, prevState, { touched: setIn(prevState.touched, field, touched), lastTouched: field })); }, function () {
