...
export declare class Formik<Values = object, ExtraProps = {}> extends React.Component<FormikConfig<Values> & ExtraProps, FormikState<Values>> {
    ...
    getFormikBag: () => {
        ...
        submitForm(): void;
        setFormikState<K extends "error" | "values" | "errors" | "touched" | "lastTouched" | "isValidating" | "isSubmitting" | "status" | "submitCount">(f: (prevState: Readonly<FormikState<Values>>, props: any) => Pick<FormikState<Values>, K>, callback?: (() => any) | undefined): void;
        setFormikState<K extends "error" | "values" | "errors" | "touched" | "lastTouched" | "isValidating" | "isSubmitting" | "status" | "submitCount">(state: Pick<FormikState<Values>, K>, callback?: (() => any) | undefined): void;
        values: Values;
        error?: any;
