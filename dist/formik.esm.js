...
function (_super) {
  ...
  FastFieldInner.prototype.shouldComponentUpdate = function (props) {
    ...
    return props.formik.lastTouched === this.props.name && (this.props.formik.isSubmitting !== props.formik.isSubmitting || Object.keys(this.props).length !== Object.keys(props).length || getIn(this.props.formik.values, this.props.name) !== getIn(props.formik.values, this.props.name) || getIn(this.props.formik.errors, this.props.name) !== getIn(props.formik.errors, this.props.name) || getIn(this.props.formik.touched, this.props.name) !== getIn(props.formik.touched, this.props.name));
  };
